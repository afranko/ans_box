...
public class TimeData {
  ...
  public TimeData(String meas_loc_site, int meas_loc_id, String gmt_event, int ordering_seq, String eu_db_site, int eu_db_id, int eu_type_code,
                  String secs_or_revs, float off_secs_or_revs, float max_secs_or_revs, float number_of_samples, String win_db_site, int win_db_id,
                  int win_type_code, String complex_yn, String waveform_data) {
    super();
