...
public class EnvironmentMeas {
    ...
    @Expose
    private List<HasAttribute> hasAttributes = new ArrayList<HasAttribute>();
    ...
    public EnvironmentMeas(List<HasAttribute> hasAttributes, HasEventDescriptionUuid hasEventDescriptionUuid, HasLocation hasLocation, HasTimestamp hasTimestamp) {
        super();
